import type { Sortable } from '@mubox-core/composables';
import type { EmitType } from '@mubox-core/typings';

import type { TabsProps } from './types';

import { useIsMobile, useSortable } from '@mubox-core/composables';
