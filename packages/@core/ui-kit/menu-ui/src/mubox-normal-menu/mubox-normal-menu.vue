...
import type { MuboxNormalMenuProps } from './mubox-normal-menu';

import { useNamespace } from '@mubox-core/composables';
import { MuboxIcon } from '@mubox-core/mubox-ui';

interface Props extends MuboxNormalMenuProps {}

defineOptions({
  name: 'MuboxNormalMenu',
});
...
<template>
  ...
  >
    <template v-for="menu in menus" :key="menu.path">
      ...
      >
        <MuboxIcon :class="e('icon')" :icon="menuIcon(menu)" fallback />
