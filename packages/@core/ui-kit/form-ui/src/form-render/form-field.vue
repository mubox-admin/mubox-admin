...
import { MuboxRenderContent } from '@mubox-core/mubox-ui';
import {
  FormControl,
  FormDescription,
  FormField,
...
import { cn, isFunction, isObject, isString } from '@mubox-core/shared/utils';
    ...
    >
      ...
      <div :class="cn('relative flex w-full items-center', wrapperClass)">
        ...
        <div v-if="suffix" class="ml-1">
          <MuboxRenderContent :content="suffix" />
        </div>

        <FormDescription v-if="description">
          <MuboxRenderContent :content="description" />
        </FormDescription>
