import type { MuboxButtonProps } from '@mubox-core/mubox-ui';
...
export interface ActionButtonOptions extends MuboxButtonProps {
  [key: string]: any;
  content?: string;
  show?: boolean;
}

export interface MuboxFormProps<
  T extends BaseFormComponentType = BaseFormComponentType,
> extends Omit<
    FormRenderProps<T>,
...
export type ExtendedFormApi = FormApi & {
  useStore: <T = NoInfer<MuboxFormProps>>(
    selector?: (state: NoInfer<MuboxFormProps>) => T,
  ) => Readonly<Ref<T>>;
};

export interface MuboxFormAdapterOptions<
  T extends BaseFormComponentType = BaseFormComponentType,
> {
  config?: {
