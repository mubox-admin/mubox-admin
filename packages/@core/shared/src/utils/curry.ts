 ...
 */
export function throttle(callback: Function, delay = 200, options: ThrottleOptions = {}) {
 ...
 */
export function debounce(callback: Function, delay = 200, options: debounceOptions = {}) {
