import type { IContextMenuItem } from '@mubox-core/tabs-ui';
import type { TabDefinition } from '@mubox/types';
import type { RouteLocationNormalizedGeneric } from 'vue-router';

import { useContentMaximize, useTabs } from '@mubox/hooks';
import { $t, useI18n } from '@mubox/locales';
import { useAccessStore, useTabbarStore } from '@mubox/stores';
import { filterTree } from '@mubox/utils';
import {
  ArrowLeftToLine,
  ArrowRightLeft,
  ArrowRightToLine,
