...
import type { BuiltinThemePreset } from '@mubox-core/preferences';
import type { BuiltinThemeType } from '@mubox/types';

import { BUILT_IN_THEME_PRESETS } from '@mubox-core/preferences';

import { $t } from '@mubox/locales';
import { convertToHsl, TinyColor } from '@mubox/utils';
