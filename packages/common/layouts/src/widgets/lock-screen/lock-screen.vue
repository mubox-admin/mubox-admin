...
import { useScrollLock } from '@mubox-core/composables';
import { useMuboxForm, z } from '@mubox-core/form-ui';
import { MuboxAvatar, MuboxButton } from '@mubox-core/mubox-ui';
import { $t, useI18n } from '@mubox/locales';
import { storeToRefs, useLockStore } from '@mubox/stores';
...
const [Form, { form, validate }] = useMuboxForm(
  reactive({
    commonConfig: {
      hideLabel: true,
    ...
    <transition name="slide-right">
      ...
      >
        <div class="flex-col-center mb-10 w-[300px]">
          <MuboxAvatar :src="avatar" class="enter-x mb-6 size-20" />

          <div class="enter-x mb-2 w-full items-center">
            <Form />
          </div>
          <MuboxButton class="enter-x w-full" @click="handleSubmit">
