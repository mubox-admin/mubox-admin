...
import { Bell, MailCheck } from 'lucide-vue-next';
  ...
  >
    <template #trigger>
      <div class="flex-center mr-2 h-full" @click.stop="toggle()">
        <MuboxIconButton class="bell-button text-foreground relative">
          <span
            v-if="dot"
    ...
    <div class="relative">
      ...
      <MuboxScrollbar v-if="notifications.length > 0">
      ...
      >
        ...
        <MuboxButton size="sm" @click="handleViewAll">
